...
{`created -> active (writing + trading) -> expired (awaiting price)
      ...
      <H2 id="create">Create a series</H2>
      <p>
      ...
      <H2 id="close-pair">Close a pair (early exit)</H2>
      <p>
      ...
      <H2 id="claim">Exercise and reclaim</H2>
      <p>
